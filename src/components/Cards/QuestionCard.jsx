...
const QuestionCard = ({ 
  ...
  return (
  <>
    <div className="bg-white rounded-lg overflow-hidden py-4 px-5 shadow-x shadow-gray-100/50 border border-gray-100/60 group">
        <div className="flex items-start justify-between cursor-pointer">
            ...
            <div className="flex items-center justify-end ml-4 relative">
                ...
                <button
                    className="flex items-center gap-2 text-xs text-cyan-800 font-medium bg-cyan-50 px-3 py-1 rounded mr-2 text-nowrap border border-cyan-50 hover:border-cyan-200 cursor-pointer"
                    onClick={()=>{
                        setIsExpanded(true);
                        onLearnMore();
                    }}
