...
const AIResponsePreview = ({ content }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
                <div className="text-[14px] prose prose-slate dark:prose-invert maxx-w-none">
            <ReactMarkdown
    ...
    return <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
        <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
            ...
            >
                ...
                {copied && (
                    <span className="absolute -top-8 bg-black text-white text-xs rounded px-2 py-1 opacity-80 group-hover:opacity-100 transition">
                        Copied !
                    </span>
                )}
            </button>
