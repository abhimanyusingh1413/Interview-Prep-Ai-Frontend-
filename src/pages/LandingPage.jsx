...
const LandingPage = () => {
  ...
  <div className="w-full min-h-screen bg-[#FFFCEF] relative overflow-hidden">
    {/* Blurred Background */}
    <div className="absolute top-0 left-0 z-0 w-[300px] h-[300px] md:w-[500px] md:h-[500px] bg-amber-200/20 blur-[65px]"></div>

    {/* Header */}
    <header className="flex justify-between items-center mb-10 md:mb-16 relative z-10 px-4 md:px-8 pt-6">
      <div className="text-xl text-black font-bold">Welcome to Interview Prep AI</div>
      { user ? (
        <ProfileInfoCard />
       ):(
        <button
        className="bg-gradient-to-r from-[#FF9324] to-[#e99a4b] text-sm font-semibold text-white px-6 py-2.5 rounded-full hover:bg-black hover:text-white border border-white transition-colors cursor-pointer"
    ...
    {/* Hero Content */}
    <div className="flex flex-col md:flex-row items-center relative z-10 px-4 md:px-8">
      {/* Left Text Section */}
      <div className="w-full md:w-1/2 md:pr-6 mb-8 md:mb-0">
        <div className="flex items-center justify-start mb-2">
          <div className="flex items-center gap-2 text-[13px] text-amber-600 bg-amber-100 px-3 py-1 rounded-full border border-amber-300">
  ...
  <div className="w-full min-h-full relative z-10">
    <section className="flex items-center justify-center mt-10 md:-mt-36 px-4">
      <img src={HERO_IMG} alt="hero image" className="w-full max-w-[90vw] md:max-w-[80vw] rounded-lg" />
    </section>
  </div>
  ...
  <div className="text-sm bg-gray-50 text-secondary text-center p-5 mt-5">
    Made with ❤️...by Abhimanyu Kumar
  </div>
